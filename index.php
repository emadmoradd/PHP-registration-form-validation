...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
  ...
  if(!$username){
    ...
    $errors['username'] = 'Username must be less than 20 and more than 6 chars';
  }
  if(!$email){
...
function post_data($field){
  if(!isset($_POST[$field])){
    ...
    return htmlspecialchars(stripcslashes(trim($_POST[$field])));
  }
}
    ...
    <div class="row">
      ...
      <div class="col">
        <div class="form-group">
          ...
          <input type="password"
                  class="form-control <?php echo isset($errors['password_confirm']) ? "is-invalid" : "" ?>" name="password_confirm" value="<?php echo $password_confirm ?>">
          <div class="invalid-feedback">
